    ...
    <div className="ps-product--detail ps-product--quickview">
      <div className="ps-product__header">
        ...
        <div className="ps-product__info">
          ...
          <ModuleDetailShoppingActions product={quickProduct} extended={true} selectedAttributeProduct={selectedAttributeProduct}/>
          <ModuleProductDetailSpecification selectedAttributeProduct={selectedAttributeProduct}/>
