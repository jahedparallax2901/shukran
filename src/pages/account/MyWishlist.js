              ...
              <div key={index} className="wishlist">
                <div className="wishlist-item py-0">
                  ...
                  >
                    ...
                    <div onClick={(e)=>{
                     handleRemoveData(e , data.product.id)
                    }} className="actions">
          ...
          <div className="row">
            <div className="col-lg-3">
              <div className="ps-page__left">
                <AccountMenuSidebar selectedTab={"My Wishlist"} />
              </div>
            </div>
              ...
              <div className="ps-page__content card">
                <div className="ps-section--account-setting">
                  ...
                  <div className="card-body pt-3 pb-3" id="pills-tabContent">
                    {isLoading ? <div className="d-flex justify-content-center w-100 align-items-center">
