...
export const CHECK_UNCHECK_CART_ITEM_REQUEST = 'CHECK_UNCHECK_CART_ITEM_REQUEST';
export const CHECK_UNCHECK_CART_ITEM_SUCCESS = 'CHECK_UNCHECK_CART_ITEM_SUCCESS';
export const CHECK_UNCHECK_CART_ITEM_FAILURE = 'CHECK_UNCHECK_CART_ITEM_FAILURE';
